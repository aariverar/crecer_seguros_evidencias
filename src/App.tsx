...
// Tema personalizado de Crecer Seguros (Azul Marino)
const crecerTheme = createTheme({
  palette: {
    primary: {
      main: '#003366', // Azul Marino Crecer Seguros
      light: '#336699',
      dark: '#001A33',
      contrastText: '#FFFFFF'
    },
...
function App() {
  ...
  return (
  <ThemeProvider theme={crecerTheme}>
          ...
          <AppBar position="static" elevation={0}>
            <Toolbar sx={{ justifyContent: 'center', position: 'relative' }}>
              <Typography variant="h6" component="div" sx={{ fontWeight: 600, color: '#FFFFFF' }}>
                Crecer Seguros - Generador de Evidencias
              </Typography>
              <Box sx={{ position: 'absolute', right: 16, display: 'flex', alignItems: 'center', gap: 1 }}>
                <Box sx={{ width: 40, height: 40, backgroundColor: 'white', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <Typography sx={{ color: '#003366', fontWeight: 'bold', fontSize: '18px' }}>QA</Typography>
                </Box>
              </Box>
            </Toolbar>
          </AppBar>
          ...
          <Container maxWidth="lg" sx={{ py: 4, display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
              ...
              <Box component="form" onSubmit={handleSubmit} sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
                ...
                <Box sx={{ mt: 4, width: '100%', maxWidth: 800, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                  ...
                  <Box
                    ...
                    onDrop={handleDrop}
                    sx={{
                      border: `2px dashed ${isDragOver ? '#003366' : '#CCCCCC'}`,
                      borderRadius: 2,
                      p: 3,
                      textAlign: 'center',
                  ...
                  >
                    <input
                      ...
                      style={{ display: 'none' }}
                    />
                    <CloudUpload sx={{ fontSize: 48, color: '#003366', mb: 2 }} />
            ...
            <Box sx={{ 
              ...
              <Typography variant="body2" color="text.secondary" sx={{ fontWeight: 500 }}>
                © Crecer Seguros - Aseguramiento de Calidad
              </Typography>
              <Typography variant="caption" color="text.secondary" sx={{ mt: 0.5, display: 'block' }}>
                Powered by Erika Hernandez | Support: erika.hernandez@tsoftglobal.com - {new Date().getFullYear()}
              </Typography>
            </Box>
